...
exports.findAll = async (req, res) => {
    try {
        ...
        for (const book of books) {
            ...
            const productCount = await BookAuthor.count({
                where: {
                    BookId: book.id
                }
            });
...
exports.delete = async (req, res) => {
    ...
    try {
        ...
        // Предварительное удаление связанных записей в других таблицах
        await BookCategory.destroy({
            where: {
                BookId: bookId
            }
        ...
        // Теперь можно удалить запись из таблицы books
        await book.destroy();
